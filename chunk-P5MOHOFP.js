...
// apps/findqo-ireland/src/app/core/services/confetti.service.ts
var ConfettiService = class _ConfettiService {
  celebrate() {
    const DURATION = 5e3;
    confetti_module_default({
      ...
      angle: 90,
      origin: { y: 0.6 },
      colors: ["#ee0088", "#B6005B", "#ee0088", "#B6005B"]
    });
    setTimeout(() => confetti_module_default.reset(), DURATION);
  }
  static {
    this.\u0275fac = function ConfettiService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ConfettiService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ConfettiService, factory: _ConfettiService.\u0275fac });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ConfettiService, [{
    type: Injectable
  }], null, null);
})();
...
//# sourceMappingURL=chunk-P5MOHOFP.js.map
