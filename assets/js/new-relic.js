...
// eslint-disable-next-line no-undef
NREUM.loader_config = { accountID: '2834873', trustKey: '2834873', agentID: '538618379', licenseKey: 'NRJS-ba4ecf8a84a24758b03', applicationID: '538618379' };
// eslint-disable-next-line no-undef
NREUM.info = {
	beacon: 'bam.eu01.nr-data.net',
	errorBeacon: 'bam.eu01.nr-data.net',
	licenseKey: 'NRJS-ba4ecf8a84a24758b03',
	applicationID: '538618379',
	sa: 1,
...
(() => {
	var e,
		...
		r = {
							...
							session_replay: {
								...
								set block_selector(t) {
									d(t)
										...
										: '' !== t && (0, f.R)('An invalid session_replay.block_selector was provided and will not be used', t);
								},
			...
			7864: (e, t, r) => {
				...
				function i(e, t) {
					try {
						...
						if (!t || 'object' != typeof t) return (0, n.R)('Setting a Configurable requires a model to set its initial properties');
			...
			8941: (e, t, r) => {
				'use strict';
				r.d(t, { um: () => f, NZ: () => x, vC: () => T, Ri: () => O, Ak: () => _, o8: () => C, MO: () => U, bX: () => V });
				var n = r(7836),
					i = r(3434),
					o = r(8990),
					a = r(6154);
							...
							try {
								r.emit('new-xhr', [t], n),
									t.addEventListener(
										...
										function () {
											var e = this;
											e.readyState > 3 && !i.resolved && ((i.resolved = !0), r.emit('xhr-resolved', [], e)), o.inPlace(e, h, 'fn-', x);
										}),
										(0, E.jT)(!1)
									);
							} catch (e) {
			...
			425: (e, t, r) => {
				...
				var m = r(1863),
					...
					x = r(3434);
				function R(e, t, r, n) {
					if ('object' != typeof t || !t || 'string' != typeof r || !r || 'function' != typeof t[r]) return (0, d.R)(b.bu + 'invalid argument(s)');
					const i = (function (e) {
						...
						void 0 === e.api &&
							(e.api = (function (e, t) {
								...
								function N(t, r, n, o) {
									const a = (0, i.Vp)(e);
									return (
										null === r ? delete a.jsAttributes[t] : (0, i.x1)(e, { ...a, jsAttributes: { ...a.jsAttributes, [t]: r } }),
								...
								(g.log = function (e) {
									...
									(g.setCustomAttribute = function (e, t) {
										...
										} else (0, d.R)('Failed to execute setCustomAttribute.\nName must be a string type, but a type of <'.concat(typeof e, '> was provided.'));
									}),
				...
				constructor(e, r) {
					...
					this.ee.on('internal-error', (e) => {
						...
						g.gm.addEventListener(
							'unhandledrejection',
							(e) => {
								this.abortHandler && (0, O.p)('err', [K(e), (0, C.t)(), !1, { unhandledPromiseRejection: 1 }, this.#r], void 0, this.featureName, this.ee);
							},
					...
					try {
						...
						g.gm?.performance?.getEntriesByType('resource').forEach((t) => {
							if (t.initiatorType in e && 0 !== t.responseStatus) {
								...
								oe(r, t.name), this.handler('xhr', [r, n, t.startTime, t.responseEnd, e[t.initiatorType]], void 0, a.K.ajax);
							}
						});
					} catch (e) {}
					(0, Z.NZ)(this.ee),
									...
									(this.listener = function (e) {
										try {
											'abort' !== e.type || o.loadCaptureCalled || (o.params.aborted = !0),
												('load' !== e.type || (o.called === o.totalCbs && (o.onloadCalled || 'function' != typeof r.onload) && 'function' == typeof o.end)) &&
													o.end(r);
										} catch (e) {
											try {
												t.emit('internal-error', [e]);
								...
								function s(e, t) {
									...
									return (
										...
										t.traceContextParentHeader &&
											(e.set('traceparent', t.traceContextParentHeader), t.traceContextStateHeader && e.set('tracestate', t.traceContextStateHeader), (r = !0)),
										r
									);
								}
							}
				...
				async #s(e) {
					if (!this.#c) {
						...
						try {
							...
							(this.recorder ??= new t({ mode: this.#i, agentIdentifier: this.agentIdentifier, trigger: e, ee: this.ee })),
			...
			new (class extends o {
				...
				features: [
					...
					class extends b {
						...
						constructor(e, t) {
							var r;
							if ((super(e, t, we, !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2]), (r = this), !g.RI)) return;
							try {
								this.removeOnAbort = new AbortController();
							} catch (e) {}
							let n,
