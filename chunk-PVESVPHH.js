...
// apps/findqo-ireland/src/app/core/data-access/apis/property-worth.api.ts
var PropertyWorthsApi = class _PropertyWorthsApi {
  constructor(http) {
    this.http = http;
  }
  getAisleUnit(body) {
  ...
  postPropertyWorth(body) {
    return this.http.post(API.propertyWorth.base, body);
  }
  postCommercialEstimation(body) {
    return this.http.post(API.commercialOfficeEstimation.base, body);
  }
  postRentalEstimate(body) {
    return this.http.post(API.rentalEstimation.base, body);
  }
  getPurposeOptions() {
    return this.http.get(API.propertyWorth.purpose);
  }
  postInPersonValuation(id) {
    return this.http.post(API.propertyWorth.inPersonValuation, { propertyWorthId: id });
  }
  static {
    this.\u0275fac = function PropertyWorthsApi_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _PropertyWorthsApi)(\u0275\u0275inject(HttpClient));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _PropertyWorthsApi, factory: _PropertyWorthsApi.\u0275fac, providedIn: "root" });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PropertyWorthsApi, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
// apps/findqo-ireland/src/app/core/validators/phone.validator.ts
var import_google_libphonenumber = __toESM(require_libphonenumber());
var PhoneNumberValidation = class _PhoneNumberValidation {
  constructor() {
    this.phoneUtil = import_google_libphonenumber.PhoneNumberUtil.getInstance();
    this.countryCode = "IE";
  }
  phoneValidator(hasCode) {
    return (control) => {
      ...
      try {
        if (hasCode) {
          if (phoneNumber.startsWith("0")) {
            return { invalidPhone: "Phone number can't start with 0" };
          }
          if (phoneNumber.startsWith("+")) {
            return { invalidPhone: "Phone number can't start with +" };
          }
        }
        const parsedNumber = hasCode ? this.phoneUtil.parseAndKeepRawInput(phoneNumber, this.countryCode) : this.phoneUtil.parseAndKeepRawInput(phoneNumber);
        const isValid = this.phoneUtil.isValidNumberForRegion(parsedNumber, this.countryCode);
        return isValid ? null : { invalidPhone: "Unsupported phone number type for Ireland" };
      } catch (error) {
  ...
  static {
    this.\u0275fac = function PhoneNumberValidation_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _PhoneNumberValidation)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _PhoneNumberValidation, factory: _PhoneNumberValidation.\u0275fac, providedIn: "root" });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PhoneNumberValidation, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
//# sourceMappingURL=chunk-PVESVPHH.js.map
